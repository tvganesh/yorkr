...
# Date : 26 Nov 2021
# Function: runsSRPowerPlayPlotAllOppnAllMatches
...
#'
#' @usage
#' runsSRPowerPlayPlotAllOppnAllMatches(matches,theTeam)
#'
#' @param matches
...
#' runsSRPowerPlayPlotAllOppnAllMatches(matches,t1="India")
#'
#' }
#'
#' @seealso
...
#' @export
#'
runsSRPowerPlayPlotAllOppnAllMatches <- function(match,t1,plot=1) {
