...
#' @export
#'
teamRunsSRPowerPlayPlotOppnAllMatches <- function(match,t1,t2,plot=1) {
  ...
  y_lower <- quantile(a3$SRinPowerpPlay,p=0.66)

  plot.title <- paste(t1, "best batsmen in Powerplay in all matches against ",t2)
  if(plot == 1){ #ggplot2
    a3 %>%
